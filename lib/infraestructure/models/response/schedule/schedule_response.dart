class ScheduleResponse {
    ...
    factory ScheduleResponse.fromJson(Map<String, dynamic> json) => ScheduleResponse(
        schedules: List<ScheduleObjectResponse>.from(json["schedules"].map((x) => ScheduleObjectResponse.fromJson(x))),
    );
...
class ScheduleObjectResponse {
    ...
    factory ScheduleObjectResponse.fromJson(Map<String, dynamic> json) => ScheduleObjectResponse(
